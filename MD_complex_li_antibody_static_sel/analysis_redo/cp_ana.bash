...
echo 0 | gmx_mpi trjconv -s em.tpr -f  npt2.xtc -o  npt2_out.xtc  -pbc mol -ur compact -dt 100
#echo -e "1\n0\n" | gmx_mpi trjconv -s em.tpr -f  npt2_out.xtc -o  npt2_out_n.xtc  -fit rot+trans
